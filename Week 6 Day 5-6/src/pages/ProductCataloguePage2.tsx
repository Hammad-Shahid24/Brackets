...
const ProductCataloguePage2: FC = () => {
  ...
  console.log(products, isLoading, isError, errorMessage);
  ...
  //filtering on various parameters( title, category, price, rating)
...
export default ProductCataloguePage2;
